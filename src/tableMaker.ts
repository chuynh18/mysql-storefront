...
export var getLengthOfLongestItem = function (response, col) {
    var longest = 0;
...
export var generatePadding = function (lenOfLongest, lenOfCurrent) {
    var space = "";
...
export var generateHorizontalSeparator = function (howManyChar) {
    var separator = "";
