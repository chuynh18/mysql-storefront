...
// fundamentally, what a text table is... is making it so that every item in a column has the same length (num of chars)
...
export var getLengthOfLongestItem = function (response: object[], col: number | string, minLength?: number): number {
