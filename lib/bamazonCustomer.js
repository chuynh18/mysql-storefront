...
var dumpTableContents = function () {
    connection.query("SELECT item_id, product_name, price FROM products", function (err, res) {
        if (err)
            throw err;
        // console.log(res);
        var idLength = getLengthOfLongestItem(res, "item_id");
        var productLength = getLengthOfLongestItem(res, "product_name");
        var priceLength = getLengthOfLongestItem(res, "price");
...
var getLengthOfLongestItem = function (response, col) {
