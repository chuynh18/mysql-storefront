...
var addProduct = function () {
    ...
    inquirer
        ...
        createDbConnection_1.connection.query("INSERT INTO products (product_name, department_name, maker, product_description, price, stock_quantity) VALUES ('" + name + "', '" + department + "', '" + maker + "', '" + description + "', " + price + ", " + quantity + ")", function (err, res) {
